...
CATALOG_MODELS: List[ModelEndpoint] = [
    ...
    ModelEndpoint(
        ...
        rpd_limit=50,
        tpm_limit=32_000,
        monthly_token_budget="~4M",
        monthly_token_budget_tokens=4_000_000,
        supports_vision=True,
        supports_tools=True,
        base_url="https://generativelanguage.googleapis.com/v1beta/openai",
        recommended_use="Massive 2M token context for whole-codebase and archival document analysis",
        modality="chat"
    ),
    ...
    ModelEndpoint(
        id="openrouter/deepseek/deepseek-v3.1:free",
        platform="openrouter",
        ...
        recommended_use="Frontier-tier open weights model for complex competitive intelligence and PRD generation",
        modality="chat"
    ),
    ModelEndpoint(
        ...
        is_reasoning=True,
        base_url="https://openrouter.ai/api/v1",
        recommended_use="Deep chain-of-thought reasoning for market validation and risk assessment",
        modality="chat"
    ),
    ModelEndpoint(
        ...
        is_coding=True,
        base_url="https://openrouter.ai/api/v1",
        recommended_use="SWE-bench top tier for technical user stories, API designs, and schema architectures",
        modality="chat"
    ),
    ModelEndpoint(
        ...
        supports_tools=True,
        base_url="https://openrouter.ai/api/v1",
        recommended_use="Multi-agent orchestration, complex task decomposition, and PRD breakdown",
        modality="chat"
    ),
    ModelEndpoint(
        ...
        supports_tools=True,
        base_url="https://openrouter.ai/api/v1",
        recommended_use="Enterprise-grade reasoning and domain analysis",
        modality="chat"
    ),
    ModelEndpoint(
        ...
        display_name="Llama 3.3 70B (free OR)",
        family="Llama",
        intelligence_rank=6,
        speed_rank=5,
        size_label="Large",
        ...
        supports_tools=True,
        base_url="https://openrouter.ai/api/v1",
        recommended_use="Reliable fallback for product strategy and discovery",
        modality="chat"
    ),
